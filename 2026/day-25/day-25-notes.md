...
5. Answer in your notes:
   ...
   ![alt text](Git-reset.jpg)  
   ![alt text](Git-reset-2.jpg)  
   ![alt text](git-reset-3.jpg)
---
...
3. Check `git log` — is commit Y still in the history?  
   git revert works on a reverse order, so it will create a conflict if we try to revert in the middle of commit. so always revert from the top of Head.  
   ![alt text](git-revert.jpg)
